                ...
                <div class="card-body">
                    <form action="{{ route('brand.update', ['id'=>$brand->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <label for="Active" class="form-label"><input type="radio" name="status"  id="Active" {{ $brand->status == 1 ? 'checked' : '' }} class="label radio">Active
                            </label>
                            &nbsp;
                            &nbsp;
                            <label for="Deactive" class="form-label"><input type="radio" name="status" value="0" id="Deactive" {{ $brand->status == 0 ? 'checked' : '' }} class="label radio">Deactive
                            </label>
                        </div>
                        <div>
