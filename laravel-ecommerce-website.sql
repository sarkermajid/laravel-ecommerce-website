...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2023 at 11:53 AM
...
--
-- Database: `laravel-ecommerce-website`
--
...
(5, 'Jewllery and Watches', 'jewllery-and-watches-4505', '', 1, 0, 'jewellery-and-watches-16541700793194.webp', '2023-11-23 20:33:14', '2023-11-24 02:58:32'),
(6, 'Health and Beauty', 'health-and-beauty-4953', '', 1, 0, 'health-and-beauty-49531700793401.avif', '2023-11-23 20:36:41', '2023-11-23 20:36:41'),
(7, 'Accessories', 'accessories-2312', '', 1, 0, 'accessories-23121700793523.avif', '2023-11-23 20:38:43', '2023-11-23 20:38:43');
...
(1, 'header_logo', '1700791224.png', '2023-11-22 23:34:30', '2023-11-23 20:00:24'),
(2, 'header_message', 'Free Shipping for all Order of 1000 BDT', '2023-11-22 23:34:30', '2023-11-24 04:50:02'),
(3, 'shop_address', 'Dhaka - 1203, Bangladesh', '2023-11-22 23:34:30', '2023-11-24 04:50:02'),
(4, 'shop_phone', '01521429619', '2023-11-22 23:34:30', '2023-11-24 04:50:02'),
(5, 'shop_email', 'sailor21@gmail.com', '2023-11-22 23:34:30', '2023-11-24 04:50:02'),
(6, 'currency', '৳', '2023-11-22 23:34:30', '2023-11-24 04:50:02'),
(7, 'footer_logo', '1700821037.png', '2023-11-22 23:34:30', '2023-11-24 04:17:17'),
(8, 'facebook_link', 'https://www.facebook.com/sarkermajid21/', '2023-11-22 23:34:30', '2023-11-24 04:50:02'),
(9, 'instagram_link', 'https://www.instagram.com/sarker_majid/', '2023-11-22 23:34:30', '2023-11-24 04:50:02'),
(10, 'twitter_link', NULL, '2023-11-22 23:34:30', '2023-11-24 04:50:02'),
(11, 'linkedin_link', 'https://www.linkedin.com/in/sarkermajid/', '2023-11-22 23:34:30', '2023-11-24 04:50:02'),
(12, 'open_time', '10 AM - 10 PM', '2023-11-22 23:34:30', '2023-11-24 04:50:02'),
(13, 'frontend_site_link', 'http://127.0.0.1:8000/', NULL, '2023-11-24 04:50:02');
...
CREATE TABLE `products` (
  ...
  `discount_type` tinyint(4) DEFAULT NULL COMMENT '1 = percentage, 0 = fixed amount',
...
CREATE TABLE `promo_codes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `title` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` tinyint(4) NOT NULL DEFAULT 0 COMMENT '1 = percentage, 0 = fixed',
...
CREATE TABLE `users` (
  ...
  `image` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '1 = active, 0 = deactive',
  `role_as` tinyint(4) NOT NULL DEFAULT 0 COMMENT '1 = Admin, 0 = Users',
...
(1, 'Admin', 'admin@gmail.com', NULL, NULL, '$2y$10$ZRuBdJdBEbGg/FPK7VG3VOgH5P5LQRXdlsGTd.74sAJM.dDpin.96', NULL, NULL, NULL, '1700722847.jpg', '1', 1, NULL, '2023-11-22 23:34:47', '2023-11-23 01:00:47'),
(2, 'User', 'user@gmail.com', NULL, NULL, '$2y$10$/kevmU0WnSH0OKZZK0NjPe1Gj04S3l0HXqdo8rxWHvU5ariz3JhHe', NULL, NULL, NULL, NULL, '1', 0, NULL, '2023-11-22 23:34:47', NULL),
(3, 'Sarker Majid', 'sarkermajid@gmail.com', NULL, NULL, '$2y$10$yxDUrvPkqe.A186zjC7YeO71qi9sau4zYQiPzSEIebL8powUic3yS', NULL, NULL, NULL, NULL, '1', 0, NULL, '2023-11-25 04:20:51', '2023-11-25 04:20:51');
